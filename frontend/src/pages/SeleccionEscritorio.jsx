...
const SeleccionEscritorio = () => {
  ...
  return (
    <>
      <Titulo textoClaro={"En que Escritorio trabajará"} textoOscuro={"Hoy?"} />
          ...
          <form className="mb-5 bg-white rounded-lg shadow-lg px-10 py-10">
            ...
            {idAcaja != 0 && (
              <div className="mt-6 justify-end flex">
                <BotonVolver
                  ruta={"/dashboard/servicio_al_cliente"}
                  texto="Continuar"
...
export default SeleccionEscritorio;
