        ...
        <div className="md:w-2/3 lg:w-2/5 mt-6 rounded-lg">
          {
            ...
            retiro && (
              <Alerta alerta={{ error: false, msg: "Deposito Exitoso xD" }} />
            )
          }
          <form
          ...
          >
            <div className="flex w-full flex-row align-bottom justify-center">
              <label
            ...
            <div className="flex w-full flex-row align-bottom justify-center mt-2">
              <label
            ...
            <div className="flex justify-center pt-8">
              <button
                disabled={disponible}
                type="submit"
                className={`text-white text-sm bg-green-800 p-3 rounded-md uppercase font-bold hover:bg-green-700 ${
                  disponible ? "cursor-not-allowed" : "cursor-auto"
                }`}
              >
                Depositar
              </button>
